...
"""
Change Logger Hook
Logs every file mutation (Edit, Write, Bash) to a CSV file for session review.
...
# Log file in .claude directory (absolute path for reliability)
CSV_PATH = os.path.join(os.path.expanduser("~"), ".claude", "critical_log_changes.csv")
