...
---
## GCP Project
- **Project Name**: <ORG_ABBR> Marketing Analytics API
...
- **Key storage**: Azure Key Vault `flkubi-kv-prd` (resource group `flkubi-prd-rg-001`), secret name `Google-<ORG>-ServiceAccount-Json`
...
- **July 2020**: Tom asked <ORG_PARENT> (Glen Hamilton, Michelle Smith) to grant project access to <ORG_PARENT>'s BigQuery
- **Oct 2021**: Tom emailed Daniel Sheppard about BigQuery/UA/GA4/GCP data usage for UBI
- **Key people**: Tom Oyarzun (owner), Sunil Kumar (dev, used sunil1.kumar@<ORG>.com), Jon Gardiner, Glen Hamilton (<ORG_PARENT>)
