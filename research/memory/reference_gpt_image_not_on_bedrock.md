...
(us-east-2 for the PLM project), tag it with PLM tagging (`Project=<ORG_ABBR>-PLM-Drawings-AI`, add to Resource
Group `<ORG_ABBR>-PLM-Drawings-AI`). Nova Canvas returns PNGs at fixed supported dimensions (composite into A4
