---
name: ai-gov-policy
description: "Fluke AI Governance Policy — Section 5.7 (User Responsibilities) authored, humanified, and published to SharePoint FLK-InfoSec (2026-06-30)"
metadata: 
  node_type: memory
  type: project
...
## Fluke AI Governance Policy

Canonical document: `Fluke AI Gov Policy.docx` on SharePoint at `fortive.sharepoint.com/sites/FLK-InfoSec`.
Local working copy: `<USER_HOME>/OneDrive - <ORG>\AI\AI Governance\`.

**Why:** Policy previously covered org-level approval, security, legal, and risk but had no explicit individual user accountability section. Fortive governance requirements flagged the gap.
...
- Site ID: `fortive.sharepoint.com,3261e17a-9f39-45d5-a7d3-d6bb5f8e555c,fac73700-0d4b-4207-afc9-c01d81b053af`
