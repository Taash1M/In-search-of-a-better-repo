...
- [Skill Framework](project_skill_framework.md) — 16 active skills (8 standalone + 5 AI UCB companions + 1 KG + 1 doc-extract + 1 diagram), all AI UCB A+ (2026-04-07)
...
- [Presentation Beautification](project_pptx_beautify.md) — python-pptx skill with presets/palettes, mirrors docx_beautify
...
- [AI BI Tool](project_ai_bi_tool.md) — Multi-agent BI tool (Supervisor+5 Workers), SharePoint UI, PBI+OneDrive connectors, 10 agentic skills, design v0.2 (2026-04-05)
